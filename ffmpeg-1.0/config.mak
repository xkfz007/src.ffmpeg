...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-ffserver --disable-network --disable-asm --disable-optimizations --disable-stripping
prefix=/usr/local
...
CFLAGS=    -std=c99 -pthread -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes  -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
